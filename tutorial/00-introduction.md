...
<!-- 公众号封面图：assets/00-introduction-didi/cover-agent-harness.png -->
...
![Agent Demo 与生产基础设施的差距](assets/00-introduction-didi/01-demo-vs-production.png)
...
![一个目录管理一个 Agent](assets/00-introduction-didi/02-filesystem-agent-directory.png)
...
![Durable、Sandbox 与 Approval 组成安全路径](assets/00-introduction-didi/03-durable-sandbox-approval.png)
...
![子 Agent 按职责与权限交接内容包](assets/00-introduction-didi/04-subagents-handoff.png)
...
![用 Eve 规划 AI 内容运营团队路线](assets/00-introduction-didi/05-content-team-roadmap.png)
